...
function ToS() {
    return (
   <div
   className="prompt p-5 m-5 mx-auto custom-border rounded-lg bg-primary" id="promptDisplay"
   >
      <h2>Privacy Policy</h2>
      <p>Your privacy is important to us. It is Story Squad's policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://storysquad.app/">
         <span
          style={{
             color: '#fff'
          }}
         >
         https://storysquad.app/
         </span>
         </a>, and other sites and subdomains we own and operate.</p>
      ...
      <p><strong>Story Squad Data Controller</strong><br />
      Graig Peterson <br />
      storysquad.startup@gmail.com</p>
      <p>This policy is effective as of October 21, 2020.</p>
